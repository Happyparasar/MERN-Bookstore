        ...
        <Container fluid>
            <div style={{ display: "flex", marginTop: "10px" }}>
                ...
                <div style={{ marginLeft: '20px' }} >
                    ...
                    <div style={{ width: '70px', backgroundColor: 'seaGreen', borderRadius: '5px', color: 'white', padding: 'left', fontSize: '15px' }}>4.4*</div>
                    <span style={{ fontWeight: 'bold' }}>&#x20b9;{book.finalPrice}</span><span style={{ marginLeft: '10px', color: 'grey', fontSize: '17px' }}> &#x20b9;<s>{book.price}</s></span>
                    ...
                    <div>
                        ...
                        <Button  className="m-3 btn-dark btn-sm color-dark" onClick={checkStatus}>Check</Button>
                        <h6 style={{color:"red"}}>{status}</h6>
                    </div>
                    <p>
                        <Button varient='success' onClick={() => gotopurchase()}>Buy Now</Button>
                    </p>
                </div>
            </div>
        </Container>
